 ...
 */
package uk.co.alt236.resourcemirrorsampleapp.activities.resourceactivities.drawable;
...
/*package*/ class DrawableAdapter extends ResourceAdapter {

    private final static int FALLBACK = R.drawable.ic_missing_icon;

    public DrawableAdapter(final Context context,
                           final Mirror mirror,
    ...
    protected void populate(final Mirror mirror,
        ...
        final int resId = mirror.getDrawables().optResourceId(
                resourceName,
                0);
