...
public final class AnimationReflector extends AbstractResourceReflector {
    private static final ResourceType RESOURCE_TYPE = ResourceType.ANIM;
    ...
    public int optResourceId(@NonNull final String resourceName,
                             @AnimRes final int fallbackResourceId) {
